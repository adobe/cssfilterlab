...
(function() {
    ...
    ColorControl.prototype.init = function() {
        ...
        this.colorPreviewEl.focus(function () { self._onFocus(); });
    ...
    ColorControl.prototype._onFocus = function() {
        if (!this.hasColorInput){
            var colorEditor = this.colorPreviewEl,
                origValue = colorEditor.val();
                
            colorEditor
                .addClass('param-color-editor').attr("style","").attr("spellcheck","false")
                ...
                .on("keyup", function(e){
                    switch (e.keyCode){
                        ...
                        case 13:
                            e.preventDefault()
                            colorEditor.trigger("blur")
                        break
                        
                        // escape key
                        case 27:
                            colorEditor.val(origValue)
                            colorEditor.trigger("blur")
                        break
                    }
                })  
    ...
    ColorControl.prototype._onBlur = function() {
        if (!this.hasColorInput){
            this.colorPreviewEl.removeClass('param-color-editor').trigger("change")
        }
    }
    ...
    ColorControl.prototype.onMultiControlChanged = function() {
        ...
        this.colorPreviewEl.css("color", "transparent");
