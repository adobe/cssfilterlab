(function() {
    function Application() {
        ...
        this.filterStoreView = new Global.FilterStoreView(this.filterStore, this.filterList, this.activeFilterListView, this.shaderEditorView);
        ...
        this.dockView.add(this.activeFilterListView.dockPanel)
                     ...
                     .column.setWidth(350)
                     .addContainer()
                     .add(this.filterStoreView.dockPanel);
