...
(function() {
	function ShaderEditorView(filterList, github) {
        ...
        this.githubPopupContinueEl = $("#gist-popup-continue");
        this.githubPopupContinueEl.click(this.onGithubPopupContinueClicked.bind(this));   
	...
	ShaderEditorView.prototype = {
        ...
        onSaveAnonymousGistClicked: function() {
            ...
            this.githubPopupEl
                .removeClass("saved saving")
                .addClass("info")
                .show();
        },

        onGithubPopupContinueClicked: function() {
            if (!this.filter)
                return;
